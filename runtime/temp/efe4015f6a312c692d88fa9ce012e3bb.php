<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:91:"/Applications/XAMPP/xamppfiles/htdocs/tp5/public/../application/admin/view/article/edit.htm";i:1577602496;s:79:"/Applications/XAMPP/xamppfiles/htdocs/tp5/application/admin/view/public/top.htm";i:1579319019;s:80:"/Applications/XAMPP/xamppfiles/htdocs/tp5/application/admin/view/public/left.htm";i:1579694822;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                  <form class="form-horizontal" role="form" action=""
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input class="form-control" placeholder="" value="<?php echo $arts['title']; ?>" name="title"
                               required="" type="text">
                      </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input class="form-control" placeholder="" value="<?php echo $arts['author']; ?>" name="author"
                               required="" type="text">
                      </div>
                      <p class="help-block col-sm-4 red">* 必填</p>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input class="form-control" placeholder="" value="<?php echo $arts['keywords']; ?>" name="keywords"
                               required="" type="text">
                      </div>
                      <p class="help-block col-sm-4 red">* 必填</p>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        ...
                        <?php if($arts['thumb'] != ''): ?>
                        <img style="float:left;" src="<?php echo $arts['thumb']; ?>" height="30">
                        <?php else: ?>
                        暂无缩略图
                        <?php endif; ?>
                      </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        ...
                        <label style="margin-right: 15px">
                          <input  name="rec" <?php if($arts['rec'] == 1): ?>checked="checked"<?php endif; ?> value="1" type="radio">
                          <span class="text">是</span>
                        </label>
                        <label style="margin-right: 15px">
                          <input class="inverted" <?php if($arts['rec'] == 0): ?>checked="checked"<?php endif; ?> name="rec" value="0" type="radio">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <select name="cateid">
                          ...
                          <option <?php if($cate['id'] == $arts['cateid']): ?> selected="selected"  <?php endif; ?>
