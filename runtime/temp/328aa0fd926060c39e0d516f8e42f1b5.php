<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"/Applications/XAMPP/xamppfiles/htdocs/tp5/public/../application/index/view/login/index.htm";i:1580891794;}*/ ?>
<!DOCTYPE html>
...
<div class="login-container animated fadeInDown">
  <form action="" method="post">
    <div class="loginbox bg-white">
      <div class="loginbox-title">用户登陆</div>
      ...
      <div class="loginbox-textbox">
       ...
       <div class="loginbox-textbox">
        <input  class="form-control" style="width: 100px;float: left;" name="code" type="text">
         <img src="<?php echo captcha_src(); ?>" onclick="this.src='<?php echo captcha_src(); ?>?'+Math.random();" style="width: 120px;float: left;cursor: pointer" alt="captcha" />
      </div>
      ...
      <div class="loginbox-signup">
        <a href="<?php echo url('regist/index'); ?>">立即注册</a>
      </div>
