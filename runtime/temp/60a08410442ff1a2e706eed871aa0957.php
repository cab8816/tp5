<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:93:"/Applications/XAMPP/xamppfiles/htdocs/tp5/public/../application/admin/view/auth_group/lst.htm";i:1576403052;s:79:"/Applications/XAMPP/xamppfiles/htdocs/tp5/application/admin/view/public/top.htm";i:1579319019;s:80:"/Applications/XAMPP/xamppfiles/htdocs/tp5/application/admin/view/public/left.htm";i:1579694822;}*/ ?>
<!DOCTYPE html>
<html xmlns: xmlns:>
<head>
    <meta charset="utf-8">
                                        ...
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    ...
                                                    <a  class="btn btn-success btn-sm shiny">启用</a>
                                                    <?php else: ?>
                                                    <a  class="btn btn-darkorange btn-sm shiny">禁用</a>
                                                    <?php endif; ?>
                                                
                                                </td>
                                                <td><?php echo $authgroup['rules']; ?></td>
                                                <td align="center">
                                                    <a href="<?php echo url('edit',array('id'=>$authgroup['id'])); ?>"
                                                       class="btn btn-primary btn-sm shiny">
                                                        <i class="fa fa-edit"></i> 编辑
                                                    </a>
                                                    <a href="#"
                                                       onClick="warning('确实要删除吗','<?php echo url('del',array('id'=>$authgroup['id'])); ?>')"
