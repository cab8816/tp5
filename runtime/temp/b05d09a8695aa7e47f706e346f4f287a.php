<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:94:"/Applications/XAMPP/xamppfiles/htdocs/tp5/public/../application/index/view/artlist/artlist.htm";i:1579323274;s:79:"/Applications/XAMPP/xamppfiles/htdocs/tp5/application/index/view/public/top.htm";i:1581858488;s:79:"/Applications/XAMPP/xamppfiles/htdocs/tp5/application/index/view/public/pos.htm";i:1577521159;s:80:"/Applications/XAMPP/xamppfiles/htdocs/tp5/application/index/view/public/foot.htm";i:1577605768;}*/ ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
  <title>族谱交流群：484519446</title>
        ...
        <ul id="ulHot">
          <?php if(is_array($hotres) || $hotres instanceof \think\Collection || $hotres instanceof \think\Paginator): $i = 0; $__LIST__ = $hotres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hotres): $mod = ($i % 2 );++$i;?>
           <li style="border-bottom:dashed 1px #ccc;height:70px; margin-bottom:15px;">
            <div style="float:left;width:85px;height:55px; overflow:hidden;"><a href="<?php echo url('article/article',array('artid'=>$article['id'])); ?>" target="_blank"><img src="<?php echo $hotres['thumb']; ?>" width="83"
                                                                                                                                           title="<?php echo $hotres['title']; ?>"/></a></div>
            <div style="float:right;width:145px;height:52px; overflow:hidden;"><a href="<?php echo url('article/article',array('artid'=>$article['id'])); ?>" target="_blank" title="<?php echo $hotres['title']; ?>"><?php echo $hotres['title']; ?></a></div>
          </li>
         <?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
      </div>
      ...
      <div class="widget portrait">
        <div>
          <div class="textwidget">
            <a href="/tougao.html"><img src="/tp5/public/static/index/style/img/tg.jpg" alt="鎶曠ǹ"></a><br><br>
