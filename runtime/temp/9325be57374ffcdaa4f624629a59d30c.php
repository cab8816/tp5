<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"/Applications/XAMPP/xamppfiles/htdocs/tp5/public/../application/admin/view/cate/lst.htm";i:1575209895;s:79:"/Applications/XAMPP/xamppfiles/htdocs/tp5/application/admin/view/public/top.htm";i:1579319019;s:80:"/Applications/XAMPP/xamppfiles/htdocs/tp5/application/admin/view/public/left.htm";i:1579694822;}*/ ?>
<!DOCTYPE html>
<html xmlns: xmlns:>
<head>
    <meta charset="utf-8">
                                    ...
                                    <form action="" method="post">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><input name="<?php echo $cate['id']; ?>" style="width: 50px ;text-align: center"
                                                                          type="text"
                                                                          value="<?php echo $cate['sort']; ?>"></td>
                                                <td><?php if($cate['level'] != 0): ?>+<?php endif; ?>
                                                    <?php echo str_repeat('-',$cate['level']*5)?><?php echo $cate['catename']; ?>
                                                </td>
                                                <td align="center">
                                                    <?php if($cate['type'] == 1): ?>
                                                    文章列表
                                                ...
                                                <td align="center">
                                                    <a href="<?php echo url('edit',array('id'=>$cate['id'])); ?>"
                                                       class="btn btn-primary btn-sm shiny">
                                                        <i class="fa fa-edit"></i> 编辑
                                                    </a>
                                                    <a href="#"
                                                       onClick="warning('确实要删除吗','<?php echo url('del',array('id'=>$cate['id'])); ?>')"
