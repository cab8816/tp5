<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"C:\xampp\htdocs\tp5\public/../application/admin\view\zpadmin\add.htm";i:1578569929;s:57:"C:\xampp\htdocs\tp5\application\admin\view\public\top.htm";i:1574082531;s:58:"C:\xampp\htdocs\tp5\application\admin\view\public\left.htm";i:1578099398;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
          ...
          <div class="col-lg-12 col-sm-12 col-xs-12">
            <div class="widget">
              <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">新增家谱</span>
              </div>
                ...
                <div id="horizontal-form">
                  <form class="form-horizontal" role="form" action="" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <select name="pid">
                          ...
                          <option <option <?php if($zpadmins['id'] == $zpadmin['id']): ?>selected="selected" <?php endif; ?>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input class="form-control" placeholder="" name="xing" type="text">
                      </div>
                      <p class="help-block col-sm-4 red">* 必填</p>
                    </div>
                     <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input class="form-control" placeholder="" name="ming" type="text">
                      </div>
                      <p class="help-block col-sm-4 red">* 必填</p>
                    </div>
                      ...
                      <div class="col-sm-6">
                        <div class="col-sm-6">
                          <select name="paih">
                            ...
                            <option value="9" >老九</option>
                            <option value="10" >老十</option>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        ...
                        <label style="margin-right: 15px">
                          <input class="inverted" checked="checked" name="guanx" value="0" type="radio">
                          <span class="text">未知</span>
                        </label>
                        <label style="margin-right: 15px">
                          <input  name="guanx" value="1" type="radio">
                          <span class="text">丈夫</span>
                        </label>
                        <label style="margin-right: 15px">
                          <input  name="guanx" value="2" type="radio">
                          <span class="text">妻子</span>
                        </label>
                            <label style="margin-right: 15px">
                          <input  name="guanx" value="3" type="radio">
                          <span class="text">儿子</span>
                        </label>
                            <label style="margin-right: 15px">
                          <input  name="guanx" value="4" type="radio">
