<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"C:\xampp\htdocs\tp5\public/../application/admin\view\zpadmin\edit.htm";i:1578559872;s:57:"C:\xampp\htdocs\tp5\application\admin\view\public\top.htm";i:1574082531;s:58:"C:\xampp\htdocs\tp5\application\admin\view\public\left.htm";i:1578099398;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
    ...
    <div class="page-content">
      ...
      <div class="page-breadcrumbs">
        <ul class="breadcrumb">
          ...
          <li>
            <a href="<?php echo url('lst'); ?>">家谱管理</a>
          </li>
                ...
                <div id="horizontal-form">
                  <form class="form-horizontal" role="form" action="" method="post">
                    ...
                    <div class="form-group">
                      <label for="name"
                             class="col-sm-2 control-label no-padding-right">父辈</label>
                      <div class="col-sm-6">
                        <select name="pid">
                    ...
                    <div class="form-group">
                      <label for="name"
                             class="col-sm-2 control-label no-padding-right">性别</label>
                      <div class="col-sm-6">
                        <div class="col-sm-6">
                          <select name="xingb">
                            <option value="0" <?php if($zpadmins['xingb'] == 0): ?>selected="selected" <?php endif; ?>>男</option>
                            <option value="1" <?php if($zpadmins['xingb'] == 1): ?>selected="selected" <?php endif; ?>>女</option>
                          </select>
                        </div>
                      </div>
                      <p class="help-block col-sm-4 red">* 必填</p>
                    ...
                    <label style="margin-right: 15px">
                      <input class="inverted" <?php if($zpadmins['guanx'] == 0): ?>checked="checked"<?php endif; ?> name="guanx" value="0" type="radio">
                      <span class="text">未知</span>
                    </label>
                    <label style="margin-right: 15px">
                      <input  name="guanx" <?php if($zpadmins['guanx'] == 1): ?>checked="checked"<?php endif; ?> value="1" type="radio">
                      <span class="text">丈夫</span>
                    </label>
                    <label style="margin-right: 15px">
                      <input  name="guanx" <?php if($zpadmins['guanx'] == 2): ?>checked="checked"<?php endif; ?> value="2" type="radio">
                      <span class="text">妻子</span>
                    </label>
                    <label style="margin-right: 15px">
                      <input  name="guanx" <?php if($zpadmins['guanx'] == 3): ?>checked="checked"<?php endif; ?> value="3" type="radio">
                      <span class="text">儿子</span>
                    </label>
                    <label style="margin-right: 15px">
                      <input  name="guanx" <?php if($zpadmins['guanx'] == 4): ?>checked="checked"<?php endif; ?> value="4" type="radio">
