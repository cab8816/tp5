<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"/Applications/XAMPP/xamppfiles/htdocs/tp5/public/../application/admin/view/link/lst.htm";i:1575294424;s:79:"/Applications/XAMPP/xamppfiles/htdocs/tp5/application/admin/view/public/top.htm";i:1579319019;s:80:"/Applications/XAMPP/xamppfiles/htdocs/tp5/application/admin/view/public/left.htm";i:1579694822;}*/ ?>
<!DOCTYPE html>
<html xmlns: xmlns:>
<head>
    <meta charset="utf-8">
                                    ...
                                    <form action="" method="post">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><input name="<?php echo $link['id']; ?>" style="width: 50px ;text-align: center"
                                                                          type="text"
                                                                          value="<?php echo $link['sortn']; ?>"></td>
                                                <td><?php echo $link['title']; ?></td>
                                                <td><a href="<?php echo $link['url']; ?>" target="_blank"><?php echo $link['url']; ?></a></td>
                                                <td><?php echo $link['descr']; ?></td>
                                                <td align="center">
                                                    <a href="<?php echo url('edit',array('id'=>$link['id'])); ?>"
                                                       class="btn btn-primary btn-sm shiny">
                                                        <i class="fa fa-edit"></i> 编辑
                                                    </a>
                                                    <a href="#"
                                                       onClick="warning('确实要删除吗','<?php echo url('del',array('id'=>$link['id'])); ?>')"
