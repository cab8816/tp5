<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"C:\xampp\htdocs\tp5\public/../application/admin\view\admin\lst.htm";i:1577187197;s:57:"C:\xampp\htdocs\tp5\application\admin\view\public\top.htm";i:1574082531;s:58:"C:\xampp\htdocs\tp5\application\admin\view\public\left.htm";i:1579093493;}*/ ?>
<!DOCTYPE html>
<html xmlns: xmlns:>
<head>
    <meta charset="utf-8">
  ...
  <!-- /Sidebar Menu -->
        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="button" tooltip="添加管理员" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href =
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                ...
                                                <a href="#"
                                                   onClick="warning('确实要删除吗','<?php echo url('del',array('id'=>$admin['id'])); ?>')"
