<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"C:\xampp\htdocs\tp5\public/../application/admin\view\conf\lst.htm";i:1575546047;s:57:"C:\xampp\htdocs\tp5\application\admin\view\public\top.htm";i:1574082531;s:58:"C:\xampp\htdocs\tp5\application\admin\view\public\left.htm";i:1578099398;}*/ ?>
<!DOCTYPE html>
<html xmlns: xmlns:>
<head>
    <meta charset="utf-8">
                                    ...
                                    <form action="" method="post">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><input name="<?php echo $conf['id']; ?>" style="width: 50px ;text-align: center" type="text" value="<?php echo $conf['sort']; ?>"></td>
                                                <td align="center"><?php echo $conf['enname']; ?></td>
                                                <td align="center"><a href="#" target="_blank"><?php echo $conf['cnname']; ?></a></td>
                                                <td align="center">
                                                     <?php if($conf['type'] == 1): ?>单行文本
                                                     <?php elseif($conf['type'] == 2): ?>多行文本
                                                     <?php elseif($conf['type'] == 3): ?>单选按钮
                                                     <?php elseif($conf['type'] == 4): ?>复选框
                                                     <?php elseif($conf['type'] == 5): ?>下拉菜单
                                                      <?php else: ?> 未知类型
                                                     <?php endif; ?>
                                                </td>
                                                ...
                                                <td align="center">
                                                    <a href="<?php echo url('edit',array('id'=>$conf['id'])); ?>"
