<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:89:"/Applications/XAMPP/xamppfiles/htdocs/tp5/public/../application/admin/view/admin/edit.htm";i:1577114200;s:79:"/Applications/XAMPP/xamppfiles/htdocs/tp5/application/admin/view/public/top.htm";i:1579319019;s:80:"/Applications/XAMPP/xamppfiles/htdocs/tp5/application/admin/view/public/left.htm";i:1581861476;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="<?php echo url('admin/edit'); ?>"
                                          method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="name"
                                                   class="col-sm-2 control-label no-padding-right">所属用户组<?php echo $groupid; ?></label>
                                            <div class="col-sm-6">
                                                <select name="group_id">
                                                    ...
                                                    <option <?php if($authgroup['id'] == $groupid): ?>selected="selected" <?php endif; ?> value="<?php echo $authgroup['id']; ?>"><?php echo $authgroup['title']; ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control"  placeholder="" id="name" name="name"
                                                       value="<?php echo $admin['name']; ?>" type="text">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control"  placeholder="" id="group_id" name="password"
                                                      value=""  type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
