                  ...
                  <form action="" method="post">
                    <table class="table table-bordered table-hover">
                      ...
                      <tr>
                        ...
                        <th class="text-center" width="10%">父亲编号</th>
                      ...
                      <tr>
                        ...
                        <td ><?php if($zpadmin['pid'] != 0): ?><?php echo str_repeat('&nbsp;&nbsp',$zpadmin['level']*3); ?>┗<?php echo str_repeat('━',1); endif; ?> <?php echo $zpadmin['name']; ?> </td>
                        <td align="center"><?php if($zpadmin['xingb'] == 0): ?>男<?php else: ?>女<?php endif; ?></td>
                        <td align="center"><?php echo $zpadmin['paih']; ?></td>
                        <td align="center"><?php if($zpadmin['guanx'] == 1): ?>丈夫<?php elseif($zpadmin['guanx'] == 2): ?>妻子<?php elseif($zpadmin['guanx'] == 3): ?>儿子<?php elseif($zpadmin['guanx'] == 4): ?>女儿<?php elseif($zpadmin['guanx'] == 0): ?>未知<?php endif; ?></td>
                        <td align="center">
