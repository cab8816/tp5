<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"C:\xampp\htdocs\tp5\public/../application/admin\view\link\edit.htm";i:1575295708;s:57:"C:\xampp\htdocs\tp5\application\admin\view\public\top.htm";i:1574082531;s:58:"C:\xampp\htdocs\tp5\application\admin\view\public\left.htm";i:1575291635;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                    ...
                                    <form class="form-horizontal" role="form" action="" method="post">
                                        ...
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <label for="name" class="col-sm-2 control-label no-padding-right">链接标题</label>

                                                <div class="col-sm-6">
                                                    <input class="form-control" placeholder="" value="<?php echo $links['title']; ?>"  name="title" required="" type="text">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="name" class="col-sm-2 control-label no-padding-right">链接地址</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="name" class="col-sm-2 control-label no-padding-right">链接描述</label>

                                                <div class="col-sm-6">
                                                    <textarea name="descr"  class="form-control"><?php echo $links['descr']; ?></textarea>
                                                </div>
                                                <p class="help-block col-sm-4 red">* 必填</p>
                                            </div>
