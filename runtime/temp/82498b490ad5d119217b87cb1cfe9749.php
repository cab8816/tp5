<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"C:\xampp\htdocs\tp5\public/../application/admin\view\auth_rule\lst.htm";i:1576503815;s:57:"C:\xampp\htdocs\tp5\application\admin\view\public\top.htm";i:1574082531;s:58:"C:\xampp\htdocs\tp5\application\admin\view\public\left.htm";i:1576494674;}*/ ?>
<!DOCTYPE html>
<html xmlns: xmlns:>
<head>
    <meta charset="utf-8">
                                    ...
                                    <form action="" method="post">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><input name="<?php echo $authrule['id']; ?>" style="width: 50px ;text-align: center"
                                                                          type="text"
                                                                          value="<?php echo $authrule['sortn']; ?>"></td>
                                                
                                                <td><?php if($authrule['level'] != 0): ?>L<?php endif; ?>
                                                    <?php echo str_repeat('_',$authrule['level']*5)?><?php echo $authrule['title']; ?></td>
                                                <td><?php echo $authrule['name']; ?></td>
                                                <td><?php echo $authrule['level']; ?>级</td>
                                                <td align="center">
                                                    <a href="<?php echo url('edit',array('id'=>$authrule['id'])); ?>"
                                                       class="btn btn-primary btn-sm shiny">
                                                        <i class="fa fa-edit"></i> 编辑
                                                    </a>
                                                    <a href="#"
                                                       onClick="warning('确实要删除吗','<?php echo url('del',array('id'=>$authrule['id'])); ?>')"
