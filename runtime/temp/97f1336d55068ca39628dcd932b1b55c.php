<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"C:\xampp\htdocs\tp5\public/../application/admin\view\auth_group\add.htm";i:1577020622;s:57:"C:\xampp\htdocs\tp5\application\admin\view\public\top.htm";i:1574082531;s:58:"C:\xampp\htdocs\tp5\application\admin\view\public\left.htm";i:1578099398;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
                        ...
                        <div class="col-sm-6">
                          <div class="col-xs-4">
                            <p class="help-block col-sm-4 red">
                              <label>
                                <input class="checkbox-slider colored-darkorange" name="status" value="1" type="checkbox" checked>
                            ...
                            <tr>
                              <td>
                                ...
                                <label>
                                  ...
                                  <input name="rules[]" value="<?php echo $authrule['id']; ?>" dataid="id-<?php echo $authrule['dataid']; ?>" type="checkbox" class="inverted checkbox-parent
