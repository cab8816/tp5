<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"/Applications/XAMPP/xamppfiles/htdocs/tp5/public/../application/admin/view/zptree/add.htm";i:1580706094;s:79:"/Applications/XAMPP/xamppfiles/htdocs/tp5/application/admin/view/public/top.htm";i:1579319019;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                  <form class="form-horizontal" role="form" action="" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input class="form-control" value="<?php echo $zpadmins['xing']; ?>" name="xing" type="text">
                      </div>
                      <p class="help-block col-sm-4 red">* 必填</p>
                    </div>
                     <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                          ...
                          <input  name="guanx" checked="checked" value="1" type="radio">
