<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"C:\xampp\htdocs\tp5\public/../application/admin\view\login\index.htm";i:1575689818;}*/ ?>
<!DOCTYPE html>
...
<div class="login-container animated fadeInDown">
  <form action="" method="post">
    <div class="loginbox bg-white">
      ...
      <div class="loginbox-textbox">
        <input value="12345" class="form-control" placeholder="password" name="password" type="password">
      </div>
       <div class="loginbox-textbox">
