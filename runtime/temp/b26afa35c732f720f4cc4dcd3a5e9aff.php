<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"C:\xampp\htdocs\tp5\public/../application/admin\view\auth_rule\edit.htm";i:1576587256;s:57:"C:\xampp\htdocs\tp5\application\admin\view\public\top.htm";i:1574082531;s:58:"C:\xampp\htdocs\tp5\application\admin\view\public\left.htm";i:1576494674;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="widget">
                            <div class="widget-header bordered-bottom bordered-blue">
                                <span class="widget-caption">编辑权限</span>
                            </div>
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" method="post">
                                        <input type="hidden" name="id" value="<?php echo $authruleres['id']; ?>">
                                        <div class="form-group">
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 control-label no-padding-right">上级权限</label>
                                                <div class="col-sm-6">
                                                    <select name="pid" >
                                                        ...
                                                        <option <?php if($authruleres['pid'] == $authrule['id']): ?> selected="selected"<?php endif; ?>  value="<?php echo $authrule['id']; ?>">
                                                        <?php if($authrule['level'] != 0): ?>L<?php endif; ?>
                                                        <?php echo str_repeat('_',$authrule['level']*5)?><?php echo $authrule['title']; ?></option>
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 control-label no-padding-right">权限名称</label>
                                                <div class="col-sm-6">
                                                    <input class="form-control" placeholder=""  value="<?php echo $authruleres['title']; ?>"  name="title" required="" type="text">
                                                </div>
                                                <p class="help-block col-sm-4 red">* 必填</p>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 control-label no-padding-right">控/方名称</label>
                                                <div class="col-sm-6">
                                                    <input class="form-control" placeholder="" value="<?php echo $authruleres['name']; ?>"  name="name" required="" type="text">
                                                </div>
                                                <p class="help-block col-sm-4 red">* 必填</p>
                                            </div>
                                            <div class="form-group">
