<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:88:"/Applications/XAMPP/xamppfiles/htdocs/tp5/public/../application/admin/view/admin/add.htm";i:1577111879;s:79:"/Applications/XAMPP/xamppfiles/htdocs/tp5/application/admin/view/public/top.htm";i:1579319019;s:80:"/Applications/XAMPP/xamppfiles/htdocs/tp5/application/admin/view/public/left.htm";i:1579694822;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="<?php echo url('admin/add'); ?>"
                                          method="post">
                                          
                                        <div class="form-group">
                                          
                                                <label for="name"
                                                       class="col-sm-2 control-label no-padding-right">所属用户组</label>
                                                <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control"  placeholder="" id="group_id" name="password"  type="text">
